...
out_dir = 'out-counting-decimal' # ignored if init_from is not 'resume'
...
from data.counting_decimal.prepare import encode, decode, generate_all, d
results = {}
with torch.no_grad():
    with ctx:
        for length in d:
            ...
            x = [y_[:y_.index(11) + 1] for y_ in y]
